...
// WithUUID adds the uuid to the get job params
func (o *GetJobParams) WithUUID(uuid string) *GetJobParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the get job params
func (o *GetJobParams) SetUUID(uuid string) {
	o.UUID = uuid
}
