...
type UploadFileParams struct {
	...
	*/
	...
	/* File.
	   ...
	   Звуковой файл с речью в формате wav
	*/
...
// WithUUID adds the uuid to the upload file params
func (o *UploadFileParams) WithUUID(uuid string) *UploadFileParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the upload file params
func (o *UploadFileParams) SetUUID(uuid string) {
	o.UUID = uuid
}
