...
// New creates a new speech to text API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for speech to text API
*/
type Client struct {
...
/*
UploadFile Эндпоинт для загрузки звукового файла (.wav)
*/
func (a *Client) UploadFile(params *UploadFileParams, opts ...ClientOption) (*UploadFileOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "uploadFile",
		Method:             "POST",
		PathPattern:        "/api/v1/upload/{Uuid}",
